...
<div class="head" id="head">
		...
		<ul>
			...
			<li style='float:left'><h2><a href="http://localhost:8080/JSP/test1.jsp">AEDI Banque</a></h2></li>
			<li style='float:right'><a href="#"><div class ="roundRectangle1"><i class="icon ion-ios-locked-outline"></i>  Accéder à mes comptes</div></a></li>
